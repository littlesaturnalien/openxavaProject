...
In openxavaProject-labels_en.properties:
openxavaProject=My application
openxavaProject[description]=My application does this and that

In openxavaProject-messages_en.properties:
